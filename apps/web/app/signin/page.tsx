          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div  className="flex hover:cursor-pointer flex-col gap-3 mb-6">
                ...
                } className="flex items-center hover:cursor-pointer justify-center gap-3 w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white text-[14px] font-medium py-2.5 rounded-lg transition-colors">
